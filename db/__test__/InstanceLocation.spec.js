...
describe('Giha class - InstanceLocation', () => {
    ...
    it( 'should initialize locations with information based on the location types.', () =>
    {
        ...
        locKeys.forEach( typeString =>
        {
            ...
            typeKeys.forEach( typeKey =>
            {
                ...
                expect( testInstanceLocation).toHaveProperty( typeKey,LOCATION_TYPES[typeString][typeKey] )
            })
    ...
    it( 'should reject bad constructor arguments' , () =>
    {
        expect( jest.fn( () =>
        {
            let testInstanceLocation = new InstanceLocation( "please don't make an instance location type with this name" )     
        })).toThrow('"please don\'t make an instance location type with this name" is not a valid location time >:O')
